...
const wears = [
    { label: 'Kurties', slug: 'kurties' },
    { label: 'Salwaar', slug: 'salwaar' },
    { label: 'Blouses', slug: 'blows' },
    { label: 'Lehenga', slug: 'lehnga' },
    { label: 'Chaniya Choli', slug: 'chaniya-choli' },
        ...
        <main className="min-h-screen bg-gradient-to-b from-pink-50 to-white">
            ...
            <section className="relative bg-gradient-to-r from-pink-700 via-pink-500 to-rose-400 text-white py-16 px-6 text-center overflow-hidden">
                ...
                <p className="mt-3 text-pink-100 text-base max-w-md mx-auto">
                    Elegance woven into every thread — explore our curated range of ethnic wear.
                </p>
            ...
            <section className="bg-gradient-to-r from-rose-400 via-pink-500 to-pink-700 text-white text-center py-12 px-6">
                <h2 className={`text-3xl mb-3 ${dancingScript.className}`}>Crafted with Love &amp; Tradition</h2>
                <p className="text-pink-100 text-sm max-w-lg mx-auto">
                    Every piece in our women&apos;s collection celebrates the beauty of Indian craftsmanship.
                </p>
            </section>
        </main>
    )
